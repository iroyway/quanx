...
var notifyText = `export ISV_SHOP_ID="${$.getdata("isvShopId")}"\nexport ISV_VENDER_ID="${$.getdata("isvVnderId")}"\nexport ISV_RED_URL="${$.getdata("isvRedUrl")}"\nexport ISV_SIGN="${$.signBody}"`;
...
function update(body) {
    text = `${body}`;
    let opt = {
        url: `https://morning-sound-04f8.iroyway.workers.dev`,
        body: `text=${text}`,
        headers: {
